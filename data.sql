...
\restrict 6afhVy9G5KmONCEygqV0RQjifvHajpJofLEGrHsDDgzv0XQTpcIA7p9wJWb4Tzj
...
CREATE TABLE public.deliveries (
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    CONSTRAINT deliveries_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'assigned'::character varying, 'in_transit'::character varying, 'delivered'::character varying])::text[])))
);
...
CREATE TABLE public.orders (
    ...
    CONSTRAINT orders_type_check CHECK (((type)::text = ANY ((ARRAY['delivery'::character varying, 'table'::character varying, 'takeaway'::character varying])::text[])))
);
...
CREATE TABLE public.payments (
    id bigint NOT NULL,
    order_id bigint NOT NULL,
    method character varying(255) DEFAULT 'card'::character varying NOT NULL,
    status character varying(255) DEFAULT 'pending'::character varying NOT NULL,
    amount numeric(10,2) NOT NULL,
    transaction_id character varying(255),
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    CONSTRAINT payments_method_check CHECK (((method)::text = ANY ((ARRAY['card'::character varying, 'cash'::character varying, 'mobile'::character varying])::text[]))),
...
--
-- Name: product_extras_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: product_extras_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.tables (
    ...
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    CONSTRAINT tables_status_check CHECK (((status)::text = ANY ((ARRAY['free'::character varying, 'occupied'::character varying, 'ordering'::character varying])::text[])))
);
...
--
-- Name: product_extras id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: order_statuses order_statuses_order_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_statuses
    ADD CONSTRAINT order_statuses_order_id_foreign FOREIGN KEY (order_id) REFERENCES public.orders(id) ON DELETE CASCADE;


--
-- Name: order_statuses order_statuses_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_statuses
    ADD CONSTRAINT order_statuses_user_id_foreign FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;
...
--
-- Name: product_extras product_extras_product_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_extras
    ADD CONSTRAINT product_extras_product_id_foreign FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE CASCADE;
...
\unrestrict 6afhVy9G5KmONCEygqV0RQjifvHajpJofLEGrHsDDgzv0XQTpcIA7p9wJWb4Tzj
